  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Lista de Serviços Cadastrados </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT * FROM tbservicos WHERE fk_empresa = '$funcempresa' ORDER BY id_servico ASC";
        ...
        //Verificar se encontrou resultado na tabela "usuarios"
          ...
          <a tabindex="0" class="btn btn-success" role="button" data-toggle="popover" data-placement="right" data-trigger="focus" href="editarservicos.php"
          title="Editar Serviços">Editar</a>
          <a tabindex="0" class="btn btn-danger" role="button" data-toggle="popover" data-placement="right" data-trigger="focus" href="excluirservicos.php"
          title="Excluir Serviços">Excluir</a>
