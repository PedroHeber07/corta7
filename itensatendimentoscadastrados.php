  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Lista de Produtos por Atendimento </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql1 = "SELECT * FROM tbitens ORDER BY id_itens_atendimento  ASC";
          ...
          if(($resultado_func) AND ($resultado_func->num_rows != 0)){
            ...
            <tbody>
              ...
              while($row_func = mysqli_fetch_array($resultado_func)){
                ?>
                <tr>
                  <th><?php echo $row_func['id_itens_atendimento']; ?></th>
                  <td><?php echo $row_func['quant_produto_atendimento']; ?></td>
                  <td><?php echo $row_func['fk_produto_atend']; ?></td>
                  <td><?php echo $row_func['fk_atendimento']; ?></td>
                </tr>
              <?php   }  ?>
            </tbody>
          </table>
