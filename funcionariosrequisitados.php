  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Funcionarios Mais Requisitados</h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT * FROM tbatendimento as a join tbfuncionario as f on f.id_func = a.fk_func_atend WHERE fk_empresa = '$funcempresa' ORDER BY nome_func desc ;";
            ...
            <tbody>
              ...
              while($row_func = mysqli_fetch_array($resultado_func)){
                ...
                <tr>
                  ...
                  <td><?php echo $row_func['id_atendimento']; ?></td>
      ...
      <div>
        <img src="graficos/funcionarios.png"  style= "display: block;
        margin-left: 325px;
        margin-right: 325px }">
        <hr />
      </div>
