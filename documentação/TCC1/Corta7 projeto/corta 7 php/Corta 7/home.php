      ...
      <div class="panel panel-default">
       ...
       <div>
        <div class="list-group">
          ...
          <a href="#" class="list-group-item list-group-item-action list-group-item-warning" onclick="fazerRequisicao('catprodutform.php', 'panel_conteudo')">Categoria de Produtos</a>
          ...
          <a href="#" class="list-group-item list-group-item-action list-group-item-danger" onclick="fazerRequisicao('financeiro.php', 'panel_conteudo')">Financeiro</a>
