...
$identrada = $_POST['inputIdEntrada'];

$objDb = new db();
$link = $objDb->conecta_mysql();

//recuperando chave estrangeira
$sql = "SELECT * FROM entradaProduto WHERE id_entradaProduto = '$identrada'";
$resultado_id = mysqli_query($link, $sql);
$dados_atend = mysqli_fetch_array($resultado_id);
$funcatend = $dados_atend['id_entradaProduto'];
...
$sql4 = " INSERT INTO itemproduto(item_produto_quantidade, fk_produto, fk_entradaProduto) values ('$primquantidade','$funcprod1','$funcatend'), ('$secquantidade','$funcprod2','$funcatend'), ('$terquantidade','$funcprod3','$funcatend')";

if (mysqli_query($link, $sql4)){
	header('Location: entradascadastradas.php');

} else {	
	echo "Erro ao registrar o Produtos na Entrada!!!";
}
