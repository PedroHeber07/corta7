  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      <div class="panel-body" id="empresaform">
        ...
        font-weight: 700;
        letter-spacing: -0.04em; color: #7c25f8;">Excluir Serviços </h3>
        <hr />
        <div class="row justify-content-center mb-6">
          <div class="col-sm-12 col-md-10 col-gl-8">
            <form method="post" action="ex_serv.php" name="formeditEmpresa"id="formeditEmpresa">
                  <div class="form-row">
                    <div class="form-group col-sm-4">
                      <label for="inputidserv">ID do Servico</label>
                      <input type="number" class="form-control" id="inputidserv" name="inputidserv" placeholder="Selecione o ID do seu Cliente" min="1">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-sm-12">
                      ...
                      title="Lista de Serviços Cadastrados">Lista de Serviços Cadastradas</a>
                    </div>
                  </div>
                </div>
              </form>
