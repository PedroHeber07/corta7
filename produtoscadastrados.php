  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Lista de Produtos Cadastrados </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT * FROM tbprodutos WHERE fk_empresa = '$funcempresa' ORDER BY produtoid ASC";
          ...
          if(($resultado_func) AND ($resultado_func->num_rows != 0)){
            ...
            <tbody>
              ...
              while($row_func = mysqli_fetch_array($resultado_func)){
                ?>
                <tr>
                  <th><?php echo $row_func['produtoid']; ?></th>
                  <td><?php echo $row_func['descricao_pro']; ?></td>
                  <td><?php echo $row_func['preco_venda']; ?></td>
                  <td><?php echo $row_func['uni_estoque']; ?></td>
                  <td><?php echo $row_func['fk_empresa']; ?></td>
                </tr>
              <?php   }  ?>
            </tbody>
          </table>
          <a tabindex="0" class="btn btn-success" role="button" data-toggle="popover" data-placement="right" data-trigger="focus" href="editarprodutos.php"
          title="Editar Produtos">Editar</a>
          <a tabindex="0" class="btn btn-danger" role="button" data-toggle="popover" data-placement="right" data-trigger="focus" href="excluirprodutos.php"
          title="Excluir Produtos">Excluir</a>
