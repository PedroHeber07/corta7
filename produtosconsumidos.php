  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Produtos Mais Consumidos </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT * FROM tbprodutos as p join tbitens as i on p.produtoid = i.fk_produto_atend WHERE fk_empresa = '$funcempresa' ORDER BY quant_produto_atendimento desc ;";
      ...
      <div>
        <img src="graficos/produtos2.png"  style= "display: block;
        margin-left: 325px;
        margin-right: 325px }">
        <hr />
      </div>
