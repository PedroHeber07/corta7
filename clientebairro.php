  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Relatório Gerencial de Clientes por Bairro </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT tbclientes.id_cliente, tbclientes.nomecli, tbclientes.bairrocli, tbclientes.fk_empresa FROM tbclientes WHERE fk_empresa = '$funcempresa' ORDER BY bairrocli ASC";
        ...
        //Verificar se encontrou resultado na tabela "usuarios"
          ...
          echo "<div class='alert alert-danger' role='alert'>Nenhum Relatório Disponível!</div>";
        }
        ?>
        <hr />
      </div>
      <div>
        <img src="graficos/grafico_clientes.png"  style= "display: block;
        margin-left: 325px;
        margin-right: 325px }">
        <hr />
      </div>
