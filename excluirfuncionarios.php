  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      <div class="panel-body" id="empresaform">
        ...
        font-weight: 700;
        letter-spacing: -0.04em; color: #7c25f8;">Excluir Funcionários </h3>
        <hr />
        <div class="row justify-content-center mb-6">
          <div class="col-sm-12 col-md-10 col-gl-8">
            <form method="post" action="ex_func.php" name="formeditEmpresa"id="formeditEmpresa">
                  <div class="form-row">
                    <div class="form-group col-sm-4">
                      <label for="inputidfunc">ID da Funcionário</label>
                      <input type="number" class="form-control" id="inputidfunc" name="inputidfunc" placeholder="Selecione o ID do seu funcionário" min="1">
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="col-sm-12">
                      ...
                      title="Lista de Funcionários Cadastradas">Lista de Funcionários Cadastradas</a>
                    </div>
                  </div>
                </div>
              </form>
