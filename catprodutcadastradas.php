  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Lista de Categoria de Produtos Cadastradas </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT * FROM tbcategoria WHERE fk_empresa = '$funcempresa' ORDER BY categoriaid ASC";
          ...
          if(($resultado_func) AND ($resultado_func->num_rows != 0)){
            ...
            <tbody>
              ...
              while($row_func = mysqli_fetch_array($resultado_func)){
                ?>
                <tr>
                  <th><?php echo $row_func['categoriaid']; ?></th>
                  <td><?php echo $row_func['nome_categoria']; ?></td>
