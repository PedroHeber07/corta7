  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      <div class="panel-body" id="clienteform">
        ...
        font-weight: 700;
        letter-spacing: -0.04em; color: #7c25f8;">Editar Clientes</h3> 
        <hr />
        <div class="row justify-content-center mb-6">
          <div class="col-sm-12 col-md-10 col-gl-8">
            <form method="post" action="edit_clientes.php" id="formCliente">
              <div class="form-row">
                <div class="form-group col-sm-6">
                  <label for="inputidcli">ID da Cliente</label>
                  <input type="number" class="form-control" id="inputidfunc" name="inputidcli" placeholder="Selecione o ID do seu Cliente" min="1">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-sm-6">
