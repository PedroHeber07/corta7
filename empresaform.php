...
<body>
	<div class="panel panel-default">
		<div class="panel-body" id="empresaform">
			...
			font-weight: 700;
			letter-spacing: -0.04em; color: #7c25f8;">Empresa </h3>
			<hr />
			<div class="row justify-content-center mb-6">
				<div class="col-sm-12 col-md-10 col-gl-8">
					<form method="post" action="inserirEmpresa.php" name="formEmpresa"id="formEmpresa">
						<div class="form-row">
							...
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control" id="inputCnpj" name="inputCnpj"placeholder="Apenas números" maxlength="11" onclick="valida_form()">
							</div>
							<div class="form-row">
