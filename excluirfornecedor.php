  ...
  <div class="container">
    ...
    <div class="panel panel-default">
      <div class="panel-body" id="empresaform">
        ...
        font-weight: 700;
        letter-spacing: -0.04em; color: #7c25f8;">Excluir Fornecedor </h3>
        <hr />
        <div class="row justify-content-center mb-6">
          <div class="col-sm-12 col-md-10 col-gl-8">
            <form method="post" action="ex_forn.php" name="formeditEmpresa"id="formeditEmpresa">
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="col-sm-12">
                      ...
                      title="Lista de Fornecedores Cadastradas">Lista de Fornecedores Cadastradas</a>
                    </div>
                  </div>
                </div>
              </form>
