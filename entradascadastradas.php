  ...
  <div class="container">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      font-weight: 700;
      letter-spacing: -0.04em; color: #7c25f8;">Lista de Entradas Cadastradas </h3> 
      <hr />
      <div class="row justify-content-center mb-6">
        ...
        //consultar no banco de dados
          $sql = "SELECT * FROM entradaProduto WHERE fk_empresa = '$funcempresa' ORDER BY id_entradaProduto ASC";
        ...
        //Verificar se encontrou resultado na tabela "usuarios"
          if(($resultado_func) AND ($resultado_func->num_rows != 0)){
            ...
            <tbody>
              ...
              while($row_func = mysqli_fetch_array($resultado_func)){
                ?>
                <tr>
                  <th><?php echo $row_func['id_entradaProduto']; ?></th>
                  <td><?php echo $row_func['data_entrada']; ?></td>
                  <td><?php echo $row_func['fk_empresa']; ?></td>
                  <td><?php echo $row_func['fk_entrada_func']; ?></td>
                  <td><?php echo $row_func['fk_entrada_forn']; ?></td>
                </tr>
              <?php   }  ?>
            </tbody>
          </table>
          ...
          title="Adicionar Produtos a Entrada">Adicionar Produtos a Entrada</a>
          ...
          <a tabindex="0" class="btn btn-danger" role="button" data-toggle="popover" data-placement="right" data-trigger="focus" href="fornecedorescadastrados.php"
          title="Editar Fornecedores">Fornecedores</a>
          ...
          echo "<div class='alert alert-danger' role='alert'>Nenhum Entrada encontrada!</div>";
        }
        ?>
      </div>
    </div>
